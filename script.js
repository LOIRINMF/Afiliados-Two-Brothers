...
var P1 = {
  Img: "https://static-media.hotmart.com/p2hiHMCUck1BIrw_vHkZHtLFOdk=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_pictures/13802bcb-f0d1-49d7-843c-7659f2e898c4/sdasdasdasdasd.JPG?w=920",
...
var P2 = {
  Img: "https://static-media.hotmart.com/sK9hsyEdWz4Wbe3ojBENtsO2GcI=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_pictures/c253a4d0-bdda-410e-861a-facdec714566/CRIATIVOFEED02.jpg?w=920",
  Nome: "MUNDO PETS",
  Preco: "R$47,00",
...
var P4 = {
  ...
  DisAntes: "Guia completo, com tudo que você precisa saber sobre a saúde do seu cão.",
  DisDepois: "Principais assuntos abordados <br>• Alimentação saudável • Alergias <br>• Treinamento • O peso ideal para a raça do seu cão <br>• Tosa • Parasitas <br>• Vermes • Socialização <br>• Cuidados dentários • Cães famosos <br>• Como preparar sua casa para seu novo hóspede <br>• Como selecionar o seu novo amigo e muito mais.",
  ...
  Compre: "https://hotm.art/SaudeDSeuPet"
};
var P5 = {
  Img: "https://static-media.hotmart.com/80aAiozdKk5sKk8JS2tcQwadY3s=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_contents/e5fafb79-3698-4c8c-b998-4ae1fa01c0c5/Capturadetela20220324173919.png?w=920",
...
var P6 = {
  Img: "https://static-media.hotmart.com/y0UKr9XgXQuUwLycQNwRbTa949Y=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_pictures/bc281fb5-0739-41b5-b22c-de71a895e195/Fotodeperfilcursohotmart.png?w=920",
...
var /*P7 = {
  ...
  DisAntes: "Se você está iniciando no Marketing Digital, esse e-book é pra você,",
  DisDepois: " agora se você já é um especialista eu acredito que você vai gostar de ter esse e-book na sua coleção.",
...
var P9 = {
  Img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuy9lKMT0_T-YgHzpongUIlCMAo5oxWnKvsg&usqp=CAU",
  Nome: "PRIMEIRA VENDA 24H",
  Preco: "R$19,90ﾠ",
...
var P10 = {
  Img: "https://static-media.hotmart.com/m40Md1_lL_nNZeKPfzvx5UACdN0=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_contents/b028571d-6315-4d3d-b8ab-1cd8e318cbcd/dicasmarketingdigital.jpg?w=920",
  Nome: "MARKETING",
  Preco: "R$149,00ﾠ",
...
var P11 = {
  Img: "https://static-media.hotmart.com/qFRrqZysGVLjou3vHq9WzAWqDeI=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_pictures/98d86f44-1ec6-483e-945e-0fececd947ce/HappyBirthdayInstagramPost41.png?w=920",
...
var P12 = {
  Img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSn-L2DJz3VDCgrNe4QgcyUNSVUx0R-mV0nUg&usqp=CAU",
  Nome: "QUEIMA GORRDURA 24Hﾠ",
  Preco: "ﾠR$19,90",
...
/*var P13 = {
  ...
  DisAntes: "Método GDF é um material que ensina o Passo a Passo de como pessoas comuns podem perder peso/",
  DisDepois: "gordura comendo pizza, chocolate, doce, e etc...<br><br> Você vai derreter sua gordura enquanto comer suas comidas prediletas.",
...
var P16 = {
  Img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuBYdM0ngPJYmkkcDCmwTn9DT0p_uo-Y1E1Q&usqp=CAU",
...
var P17 = {
  Img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZAu5_I0X579Vyh5QzeRjuUd7XA2luxJ6gjg&usqp=CAU",
...
var P18 = {
  Img: "https://static-media.hotmart.com/fc-ntE4kOIVvIbY_YWrZ1G8jz1E=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_contents/52118fa8-73de-4cca-9c6d-54585ac57bcf/sopaparabebe.jpg?w=920",
...
var P19 = {
  Img: "https://static-media.hotmart.com/-fXzKvv09pOUGQ74vo57KjwJMfI=/600x600/smart/filters:format(jpg):background_color(white)/hotmart/product_pictures/ba315fad-ba6d-409c-8e79-b64bde117a0b/capahotcardapio.png",
...
var P20 = {
  Img: "https://static-media.hotmart.com/QsJQ6-r0Imkjz2bxwApkY_Bk0lM=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_pictures/9fc74104-d947-4966-a41d-0ccd5d497170/Capanova.png?w=920",
...
var P21 = {
  Img: "https://static-media.hotmart.com/5ruzHPfwEXLf9s4G19G7xXOyyJw=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_contents/03fb7b75-7257-4a01-b6e8-f761e971ca08/FB_IMG_1585536890454.jpg?w=920",
  Nome: "RENDA EXTRA",
  Preco: "ﾠﾠR$49,90",
...
var P22 = {
  Img: "https://static-media.hotmart.com/-yHm07wlZsprKP69pC7TTKTB0hE=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_pictures/8abee7a6-36d2-4606-bda7-a340483c8fef/5205205202.png?w=920",
...
var P23 = {
  Img: "https://static-media.hotmart.com/mKtiVYtTmwJON6JKxlqtJFv1VgI=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_pictures/f381a7e2-5b6e-4285-8d28-3124db726c10/JV2012_CapaHotmart_01.png?w=920",
...
var P26 = {
  Img: "https://static-media.hotmart.com/ISnbYmjgXmX2x8zRk0gVU66PB8g=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_pictures/89fce6c3-9ce1-457a-bff2-a570f9580df1/IMG_E12131.JPG?w=920",
...
var P27 = {
  Img: "https://static-media.hotmart.com/kf_wg6IH8mSekMqB39WdzQGbz0M=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_contents/9312f559-8433-4730-879b-a3bc04a841dd/LogoHotmartMultiplicaMilhas.png?w=920",
...
var P28 = {
  Img: "https://static-media.hotmart.com/gKFK3-9VCm2PXc97xV5vreRvdJA=/300x300/smart/filters:format(webp):background_color(white)/hotmart/product_pictures/c58c3238-0264-47f2-8c5a-5ad7a869d963/Finanaspessoais.png?w=920",
...
function Tela(){
  ...
  for( var i = 0; i < Pets.length; i++){
    ...
    IFinal += '<br><br>';
    IFinal += '<a class="Compra" href="'+ Pets[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal += '</figcaption>';
    IFinal += '</figure></div>';
 ...
 //           = 0.1 =
  ...
  for( var i = 0; i < Pets2.length; i++){
    ...
    IFinal01 += '<br><br>';
    IFinal01 += '<a class="Compra" href="'+ Pets2[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal01 += '</figcaption>';
    IFinal01 += '</figure></div>';
  ...
  for( var i = 0; i < Marketing.length; i++){
    ...
    IFinal2 += '<br><br>';
    IFinal2 += '<a class="Compra" href="'+ Marketing[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal2 += '</figcaption>';
    IFinal2 += '</figure></div>';
  ...
  for( var i = 0; i < Saude.length; i++){
    ...
    IFinal3 += '<br><br>';
    IFinal3 += '<a class="Compra" href="'+ Saude[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal3 += '</figcaption>';
    IFinal3 += '</figure></div>';
  ...
  for( var i = 0; i < Receitas.length; i++){
    ...
    IFinal4 += '<br><br>';
    IFinal4 += '<a class="Compra" href="'+ Receitas[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal4 += '</figcaption>';
    IFinal4 += '</figure></div>';
  ...
  for( var i = 0; i < ReceitasPBe.length; i++){
    ...
    IFinal5 += '<br><br>';
    IFinal5 += '<a class="Compra" href="'+ ReceitasPBe[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal5 += '</figcaption>';
    IFinal5 += '</figure></div>';
  ...
  for( var i = 0; i < RendaEx.length; i++){
    ...
    IFinal6 += '<br><br>';
    IFinal6 += '<a class="Compra" href="'+ RendaEx[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal6 += '</figcaption>';
    IFinal6 += '</figure></div>';
  ...
  for( var i = 0; i < RendaExx.length; i++){
    ...
    IFinal06 += '<br><br>';
    IFinal06 += '<a class="Compra" href="'+ RendaExx[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal06 += '</figcaption>';
    IFinal06 += '</figure></div>';
  ...
  for( var i = 0; i < Jogos.length; i++){
    ...
    IFinal7 += '<br><br>';
    IFinal7 += '<a class="Compra" href="'+ Jogos[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal7 += '</figcaption>';
    IFinal7 += '</figure></div>';
  ...
  for( var i = 0; i < MilhasV.length; i++){
    ...
    IFinal8 += '<br><br>';
    IFinal8 += '<a class="Compra" href="'+ MilhasV[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal8 += '</figcaption>';
    IFinal8 += '</figure></div>';
  ...
  for( var i = 0; i < Financas.length; i++){
    ...
    IFinal9 += '<br><br>';
    IFinal9 += '<a class="Compra" href="'+ Financas[i].Compre +'"> =Compre Aqui=ﾠ </a>';
    IFinal9 += '</figcaption>';
    IFinal9 += '</figure></div>';
